...
static void parse_action_one_header (void **state)
{
  ...
  pack = amipack_parser_message (str);
...
static void parse_multi_header (void **state)
{
  ...
  pack = amipack_parser_message (str_pack);
...
static void parse_pack_with_invalid_header (void **state)
{
  ...
  assert_null(amipack_parser_message (str_pack));
}

static void parse_pack_with_multiple_headers (void **state)
{
  (void)*state;
  AMIPacket *pack;
  size_t len;
  ...
  pack = amipack_parser_message (inpack);
...
int main(void)
{
  const struct CMUnitTest tests[] = {
    ...
    cmocka_unit_test (parse_pack_with_multiple_headers),
  };

  cmocka_set_message_output(CM_OUTPUT_TAP);

  return cmocka_run_group_tests_name("Parse AMI messages.", tests, NULL, NULL);
}
