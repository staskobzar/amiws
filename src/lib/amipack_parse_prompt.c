...
#line 1 "amipack_parse_prompt.re"
/**
...
#line 53 "amipack_parse_prompt.c"
{
	unsigned char yych;
	switch (c) {
...
yy3:
	++cur;
yy4:
#line 63 "amipack_parse_prompt.re"
	{ return 0; }
#line 74 "amipack_parse_prompt.c"
yy5:
	yych = *(packet = ++cur);
	switch (yych) {
	case 's':	goto yy6;
...
#line 63 "amipack_parse_prompt.re"
	{ return 0; }
#line 229 "amipack_parse_prompt.c"
yy33:
	++cur;
#line 69 "amipack_parse_prompt.re"
	{ goto yyc_minor; }
#line 234 "amipack_parse_prompt.c"
yy35:
	++cur;
#line 68 "amipack_parse_prompt.re"
	{ ver->major = ver->major * 10 + (yych - '0'); goto yyc_major; }
#line 239 "amipack_parse_prompt.c"
/* *********************************** */
yyc_minor:
	yych = *cur;
	switch (yych) {
...
#line 63 "amipack_parse_prompt.re"
	{ return 0; }
#line 263 "amipack_parse_prompt.c"
yy41:
	yych = *++cur;
	switch (yych) {
	case '\n':	goto yy46;
...
yy42:
	++cur;
#line 72 "amipack_parse_prompt.re"
	{ goto yyc_patch; }
#line 274 "amipack_parse_prompt.c"
yy44:
	++cur;
#line 71 "amipack_parse_prompt.re"
	{ ver->minor = ver->minor * 10 + (yych - '0'); goto yyc_minor; }
#line 279 "amipack_parse_prompt.c"
yy46:
	++cur;
#line 66 "amipack_parse_prompt.re"
	{ goto done; }
#line 284 "amipack_parse_prompt.c"
/* *********************************** */
yyc_patch:
	yych = *cur;
	switch (yych) {
...
#line 63 "amipack_parse_prompt.re"
	{ return 0; }
#line 307 "amipack_parse_prompt.c"
yy52:
	yych = *++cur;
	switch (yych) {
	case '\n':	goto yy55;
...
yy53:
	++cur;
#line 74 "amipack_parse_prompt.re"
	{ ver->patch = ver->patch * 10 + (yych - '0'); goto yyc_patch; }
#line 318 "amipack_parse_prompt.c"
yy55:
	++cur;
#line 66 "amipack_parse_prompt.re"
	{ goto done; }
#line 323 "amipack_parse_prompt.c"
}
#line 75 "amipack_parse_prompt.re"
