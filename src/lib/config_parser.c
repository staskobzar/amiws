...
#endif
#define ParseARG_SDECL  struct amiws_config *pConf ;
#define ParseARG_PDECL , struct amiws_config *pConf 
#define ParseARG_FETCH  struct amiws_config *pConf  = yypParser->pConf 
#define ParseARG_STORE yypParser->pConf  = pConf 
#define YYNSTATE             18
#define YYNRULE              16
...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    15,   32,    5,   40,   12,   41,    4,   37,   36,    6,
 /*    10 */     8,   63,   14,   38,   11,   43,    9,   13,   10,   17,
 /*    20 */    16,   34,   35,   44,    3,    2,   45,    1,    7,   46,
 /*    30 */    31,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */    14,   15,   16,    4,    5,   21,   22,    4,    6,    1,
 /*    10 */     8,   11,    9,   19,    5,   23,    3,    7,    7,   12,
 /*    20 */     2,   17,    6,    6,   18,   20,    6,   13,    3,    0,
 /*    30 */     4,
};
...
static const signed char yy_shift_ofst[] = {
 /*     0 */     8,    9,   -1,    3,   10,   11,   13,   -2,   -2,   -2,
 /*    10 */     2,   16,   17,   20,   25,   26,   29,   18,
};
...
static const signed char yy_reduce_ofst[] = {
 /*     0 */     0,  -14,  -16,   -6,   -8,    4,    7,    5,    6,   14,
};
static const YYACTIONTYPE yy_default[] = {
 /*     0 */    62,   62,   62,   62,   62,   62,   62,   58,   55,   49,
...
static const char *const yyTokenName[] = { 
  ...
  "BLOCK_END",     "KEY",           "SCALAR",        "VALUE",       
  "BLOCK_SEQUENCE_START",  "BLOCK_ENTRY",   "error",         "yaml",        
  "block",         "conf",          "connections",   "field",       
  "key",           "value",         "ami_servers",   "server",      
  "entries",       "entry_field",   "entry_key",     "entry_value", 
};
#endif /* NDEBUG */
...
static const char *const yyRuleName[] = {
 /*   0 */ "yaml ::= STREAM_START block STREAM_END",
 /*   1 */ "block ::= BLOCK_MAPPING_START conf connections BLOCK_END",
 /*   2 */ "conf ::= conf field",
 /*   3 */ "conf ::=",
 /*   4 */ "field ::= key value",
 /*   5 */ "key ::= KEY SCALAR",
 /*   6 */ "value ::= VALUE SCALAR",
 /*   7 */ "connections ::= key VALUE BLOCK_SEQUENCE_START ami_servers BLOCK_END",
 /*   8 */ "ami_servers ::= ami_servers server",
 /*   9 */ "ami_servers ::=",
 /*  10 */ "server ::= BLOCK_ENTRY BLOCK_MAPPING_START entries BLOCK_END",
 /*  11 */ "entries ::= entries entry_field",
 /*  12 */ "entries ::=",
 /*  13 */ "entry_field ::= entry_key entry_value",
 /*  14 */ "entry_key ::= KEY SCALAR",
 /*  15 */ "entry_value ::= VALUE SCALAR",
};
#endif /* NDEBUG */
...
#line 782 "/home/stas/Dev/amiws/src/lib/config_parser.c"
      ...
      /* (11) entries ::= entries entry_field */ yytestcase(yyruleno==11);
        break;
/********** End reduce actions ************************************************/
  };
