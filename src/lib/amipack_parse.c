...
yy3:
	...
	goto yy13;
yy4:
#line 96 "amipack_parse.re"
	{
              if (hdr_name) free (hdr_name);
              amipack_destroy (pack);
              return NULL;
            }
#line 112 "amipack_parse.c"
yy5:
	++cur;
yy6:
#line 152 "amipack_parse.re"
	{ goto yyc_command; }
#line 118 "amipack_parse.c"
yy7:
	yyaccept = 0;
	yych = *(marker = ++cur);
	switch (yych) {
...
yy43:
#line 151 "amipack_parse.re"
	{ tok = cur; goto yyc_command; }
#line 364 "amipack_parse.c"
yy44:
	yych = *++cur;
	switch (yych) {
	case 'G':
...
yy60:
	++cur;
#line 150 "amipack_parse.re"
	{ CMD_HEADER(8, "Message"); }
#line 449 "amipack_parse.c"
yy62:
	++cur;
	yych = *cur;
	switch (yych) {
...
yy65:
	++cur;
#line 149 "amipack_parse.re"
	{ CMD_HEADER(9, "ActionID"); }
#line 468 "amipack_parse.c"
yy67:
	++cur;
	yych = *cur;
	switch (yych) {
...
yy70:
	++cur;
#line 148 "amipack_parse.re"
	{ CMD_HEADER(10, "Privilege"); }
#line 487 "amipack_parse.c"
yy72:
	yych = *++cur;
	switch (yych) {
	case '-':	goto yy73;
...
yy85:
#line 134 "amipack_parse.re"
	{
              len = cur - tok;
              hdr_name = strndup(tok, len);
              goto yyc_key;
            }
#line 573 "amipack_parse.c"
yy86:
	yych = *++cur;
	switch (yych) {
	case '\n':	goto yy95;
...
yy91:
#line 103 "amipack_parse.re"
	{ tok = cur; goto yyc_value; }
#line 601 "amipack_parse.c"
yy92:
	yych = *++cur;
	switch (yych) {
	case 'C':
...
yy107:
#line 101 "amipack_parse.re"
	{ goto done; }
#line 759 "amipack_parse.c"
yy108:
	yych = *++cur;
	switch (yych) {
	case '\n':	goto yy114;
...
yy114:
	++cur;
#line 109 "amipack_parse.re"
	{
              tok = cur;
              amipack_append(pack, hdr_name, strlen(hdr_name), strdup(""), 0);
              goto done;
            }
#line 805 "amipack_parse.c"
yy116:
	yych = *++cur;
	switch (yych) {
	case 'N':
...
yy118:
#line 129 "amipack_parse.re"
	{
              amipack_type (pack, AMI_EVENT);
              SET_HEADER("Event");
            }
#line 826 "amipack_parse.c"
yy119:
	yych = *++cur;
	switch (yych) {
	case 'N':
...
yy121:
#line 125 "amipack_parse.re"
	{
              amipack_type (pack, AMI_ACTION);
              SET_HEADER("Action");
            }
#line 847 "amipack_parse.c"
yy122:
	yych = *++cur;
	switch (yych) {
	case 'S':
...
yy125:
#line 121 "amipack_parse.re"
	{
              amipack_type (pack, AMI_RESPONSE);
              SET_HEADER("Response");
            }
#line 876 "amipack_parse.c"
yy126:
	++cur;
	yych = *cur;
	switch (yych) {
...
yy149:
	++cur;
	cur = ctxmarker;
#line 140 "amipack_parse.re"
	{ tok = cur; goto yyc_key; }
#line 1065 "amipack_parse.c"
yy151:
	++cur;
#line 101 "amipack_parse.re"
	{ goto done; }
#line 1070 "amipack_parse.c"
}
#line 159 "amipack_parse.re"
